...
bool get_code()
{
	...
	for(byte i = 0; i < 10; i++)
	{
		...
		tft.setColor(60, 60, 60);
		if(i != 0) tft.fillCircle(260 + 100 * (i - y_cursor*3), 80 + 90 * y_cursor, 40);
		else       tft.fillCircle(160, 440, 40);

		tft.setCursor(255 + 100 * (i - y_cursor*3), 90 + 90 * y_cursor);
		tft.setColor(255,255,255);
		if(i == 0) tft.setCursor(155, 450);
		tft.println(i);
	}
